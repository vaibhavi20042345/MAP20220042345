...
<!-- Mirrored from pixinvent.com/materialize-material-design-admin-template/html/ltr/vertical-modern-menu-template/form-validation.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Apr 2020 16:14:05 GMT -->
<head>
            ...
            <form class="formValidate" id="formValidate" method="get">
              <div class="row">
                <div class="input-field col s12">
                  ...
                  <input id="CouponCode" name="CouponCode" type="text" data-error=".errorTxt1">
                  <small class="errorTxt1"></small>
                </div>
                <div class="input-field col s12">
                  <label for="CompanyName">Company Name *</label>
                  <input id="CompanyName" type="text" name="CompanyName" data-error=".errorTxt2">
...
<aside id="right-sidebar-nav">
  <div id="slide-out-right" class="slide-out-right-sidenav sidenav rightside-navigation">
    ...
    <!-- END THEME  JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="../Admin/app-assets/js/scripts/form-validation.js"></script>
<script src="../Admin/app-assets/js/scripts/form-elements.min.js"></script>
    <!-- END PAGE LEVEL JS-->
  </body>

<!-- Mirrored from pixinvent.com/materialize-material-design-admin-template/html/ltr/vertical-modern-menu-template/form-validation.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Apr 2020 16:14:06 GMT -->
</html>