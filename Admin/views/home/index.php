...
<!-- Mirrored from pixinvent.com/materialize-material-design-admin-template/html/ltr/vertical-modern-menu-template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Apr 2020 16:09:52 GMT -->
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../Admin/app-assets/css/pages/intro.min.css">
    <!-- END: Page Level CSS-->
    <!-- BEGIN: Custom CSS-->
...
<!-- / Intro -->
   ...
   <?php require_once 'Admin/views/templates/footer.php' ?>
    ...
    <script src="../Admin/app-assets/vendors/chartist-js/chartist.min.js"></script>
    <script src="../Admin/app-assets/vendors/chartist-js/chartist-plugin-tooltip.js"></script>
    <script src="../Admin/app-assets/vendors/chartist-js/chartist-plugin-fill-donut.min.js"></script>
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN THEME  JS-->
    ...
    <!-- END THEME  JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="../Admin/app-assets/js/scripts/dashboard-modern.js"></script>
    <script src="../Admin/app-assets/js/scripts/intro.min.js"></script>
    <!-- END PAGE LEVEL JS-->
  </body>

<!-- Mirrored from pixinvent.com/materialize-material-design-admin-template/html/ltr/vertical-modern-menu-template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Apr 2020 16:10:25 GMT -->
</html>