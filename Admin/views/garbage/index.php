...
<!-- Mirrored from pixinvent.com/materialize-material-design-admin-template/html/ltr/vertical-modern-menu-template/table-data-table.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Apr 2020 16:14:03 GMT -->
<head>
    ...
    <title>Garbages | Saaf India</title>
    ...
    <link rel="stylesheet" type="text/css" href="../Admin/app-assets/css/pages/data-tables.min.css">
    <!-- END: Page Level CSS-->
    <!-- BEGIN: Custom CSS-->
  ...
  <body class="vertical-layout vertical-menu-collapsible page-header-dark vertical-modern-menu preload-transitions 2-columns   " data-open="click" data-menu="vertical-modern-menu" data-col="2-columns">
    ...
    <!-- BEGIN: Header-->
   <?php require_once 'Admin/views/templates/header.php' ?>
    <!-- END: Header-->
    ...
    <!-- BEGIN: SideNav-->
   <?php require_once 'Admin/views/templates/leftmenu.php' ?>
    <!-- END: SideNav-->
            ...
            <div class="row">
              <div class="col s10 m6 l6">
                ...
                <ol class="breadcrumbs mb-0">
                  ...
                  <li class="breadcrumb-item active">Garbages
                  </li>
                </ol>
              </div>
  ...
  <div class="row">
	...
	foreach($data['list']  as $detail) {
  	echo '<tr><td><a href="/garbage/garbageImage/' .$detail['Id'].'"><i class="material-icons dp48">collections_bookmark</i></a></td><td class="hide">' .$detail['Id']. '</td><td>' .$detail['User']. '</td><td>' .$detail['Location']. '</td><td>' .$detail['Notes']. '</td><td>' .$detail['CreatedDate']. '</td></tr>';
	}	
	?>
                  <!-- <tr>
                    <td>Tiger Nixon</td>
...
<!--/ Theme Customizer -->
   ...
   <?php require_once 'Admin/views/templates/footer.php' ?>
    ...
    <script src="../Admin/app-assets/vendors/data-tables/js/jquery.dataTables.min.js"></script>
    <script src="../Admin/app-assets/vendors/data-tables/extensions/responsive/js/dataTables.responsive.min.js"></script>
    <script src="../Admin/app-assets/vendors/data-tables/js/dataTables.select.min.js"></script>
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN THEME  JS-->
    ...
    <!-- END THEME  JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="../Admin/app-assets/js/scripts/data-tables.min.js"></script>
    <!-- END PAGE LEVEL JS-->
  </body>

<!-- Mirrored from pixinvent.com/materialize-material-design-admin-template/html/ltr/vertical-modern-menu-template/table-data-table.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Apr 2020 16:14:04 GMT -->
</html>